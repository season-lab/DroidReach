...
| com.imangi.templerun              | Due to nested libs, Ghidra looses some edges. Some targets are called through untracked callbacks (e.g., `ASensorManager_createEventQueue, mono_add_internal_call)`. |
